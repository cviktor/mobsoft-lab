...
import hu.bme.iemqra.mobsoft.mobsoft.network.auth.HttpBasicAuth;
import hu.bme.iemqra.mobsoft.mobsoft.network.auth.ApiKeyAuth;
import hu.bme.iemqra.mobsoft.mobsoft.network.auth.OAuth;
import hu.bme.iemqra.mobsoft.mobsoft.network.auth.OAuth.AccessTokenListener;
import hu.bme.iemqra.mobsoft.mobsoft.network.auth.OAuthFlow;
...
public class ApiClient {
   ...
   public void createDefaultAdapter() {
        ...
        String baseUrl = "https://api.restaurant.com/v1";
        if(!baseUrl.endsWith("/"))
        	baseUrl = baseUrl + "/";
